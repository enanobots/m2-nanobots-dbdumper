...
class Middlename implements DataFakerInterface
{
    /** @var array|string[]  */
    protected array $middleNames = [
        ...
        'Udo', 'Ulf', 'Uli', 'Ullrich', 'Ulrich', 'Uwe', 'Valentin', 'Veit', 'Victor', 'Viktor', 'Vincenzo', 'Vinzenz', 'Vitali', 'Vladimir', 'Volker', 'Volkmar',
    ...
    {
        return $this->middleNames[$entityId % (count($this->middleNames) - 1)];
    }
}
